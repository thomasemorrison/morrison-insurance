            ...
            {steps.map((step, i) => (
              <div key={i} className="fade-up" style={{ display: "flex", gap: "1.5rem", alignItems: "flex-start" }}>
                <div style={{ flexShrink: 0, width: "56px", height: "56px", borderRadius: "50%", backgroundColor: "var(--pine)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span style={{ fontFamily: "Lora, Georgia, serif", fontWeight: 700, fontSize: "0.875rem", color: "var(--amber-brand)" }}>{step.number}</span>
                </div>
                <div>
                  <h2 style={{ fontFamily: "Lora, Georgia, serif", fontWeight: 700, fontSize: "1.25rem", color: "var(--pine)", marginBottom: "0.625rem" }}>{step.title}</h2>
