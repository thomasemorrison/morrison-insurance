...
export default function ArticleCarInsuranceAgentsCenterTx() {
  ...
  useEffect(() => {
    ...
    setMeta("og:image", "https://morrison-ins.net/manus-storage/car-insurance-agents-center-tx-portrait_df23742b.jpg");
      ...
      >
        <div
          style={{
            position: "absolute",
            inset: 0,
            backgroundImage: "url(/manus-storage/car-insurance-agents-center-tx-portrait_df23742b.jpg)",
