...
describe("ARTICLE_META", () => {
  it("has exactly 13 article entries", () => {
    expect(Object.keys(ARTICLE_META)).toHaveLength(13);
  });
...
describe("injectArticleMeta", () => {
  ...
  // Test all 13 articles produce unique og:image values
